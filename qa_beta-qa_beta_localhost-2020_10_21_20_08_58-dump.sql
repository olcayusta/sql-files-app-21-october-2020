...
CREATE TABLE public.question (
    ...
    "rawContent" character varying(30000) NOT NULL,
...
3	7	8	Merhaba dunya.	1	2020-09-10 22:24:06.637231+03	f
1	2	8	#45, yorum beğenildi	1	2020-09-10 20:14:11.919224+03	f
2	8	8	Merhaba dunya 2	1	2020-09-10 22:23:49.681162+03	f
\.
...
COPY public.question (id, title, "rawContent", content, "creationTime", "userId", "viewCount", tags, tags2, "acceptedAnswerId") FROM stdin;
...
26	session ve üyelik adımları sayfaları	merhaba php projemde giriş yapılınca diğer sayfalara gitmeden önce kullanıcının doldurmasını istediğim 3 sayfa var. o sayfalardaki girişleri yapmadan başka hiç bir sayfaya giriş yapmasını istemiyorum.\n\nmysql user tablosunda onay sütununda bu sayfaların giriş yapıp yapmadığını kontrol ediyorum.\n\n1.php\n2.php\n3.php	<p>merhaba php projemde giriş yapılınca diğer sayfalara gitmeden önce kullanıcının doldurmasını istediğim 3 sayfa var. o sayfalardaki girişleri yapmadan başka hiç bir sayfaya giriş yapmasını istemiyorum.</p>\n<p>mysql user tablosunda onay sütununda bu sayfaların giriş yapıp yapmadığını kontrol ediyorum.</p>\n<p>1.php\n2.php\n3.php</p>\n	2020-09-24 19:45:05.705904+03	3	21	\N	\N	\N
22	Align vertically using CSS 3	With CSS 3, are there any way to vertically align an block element? Do you have an example?\nThank you.	<p>With CSS 3, are there any way to vertically align an block element? Do you have an example?\nThank you.</p>\n	2020-09-17 04:30:09.476086+03	12	501	\N	\N	\N
...
25	Localhost'ta Çalışıyor, Hosting'de Çalışmıyor?	Merhaba PT :)\n\nÜrün ekleme işlemi yapıyorum, localhostta sorunsuz çalışıyor fakat hostingde çalışmıyor. Görsel dosya izinlerinden olabilir diye görsel yükleme klasörüne 777 izni verdim, sonuç aynı.\n\n**errorInfo()** sonuçları;\n\n```Array\n(\n    [0] => 00000\n    [1] => \n    [2] => \n)\n```	<p>Merhaba PT :)</p>\n<p>Ürün ekleme işlemi yapıyorum, localhostta sorunsuz çalışıyor fakat hostingde çalışmıyor. Görsel dosya izinlerinden olabilir diye görsel yükleme klasörüne 777 izni verdim, sonuç aynı.</p>\n<p><strong>errorInfo()</strong> sonuçları;</p>\n<pre><code class="language-Array">(\n    [0] =&gt; 00000\n    [1] =&gt; \n    [2] =&gt; \n)</code></pre>\n	2020-09-24 19:44:23.555213+03	14	21	\N	\N	\N
...
57	Passing boolean in JSON in Angular	I am trying to pass a Boolean property value from Angular6 app to Java backend in JSON.\nSo I am sending to HTTP POST RESTFul API an object type \n\n    MyObj { flag: boolean = true } \n\n    createObj(obj: MyObj): Observable<WebResponse> {\n      return this.http.post(this.endPoint + 'create/' + obj, this.someUrl);\n    }\n\nHowever, on Java side we get that attribute in double quotes as `{ "flag":"true" }`, although there it is also defined as Boolean.\n\nIs there anything we can do to avoid those double quotes, to receive it as normal Boolean?	<p>I am trying to pass a Boolean property value from Angular6 app to Java backend in JSON.\nSo I am sending to HTTP POST RESTFul API an object type </p>\n<pre><code>MyObj { flag: boolean = true } \n\ncreateObj(obj: MyObj): Observable&lt;WebResponse&gt; {\n  return this.http.post(this.endPoint + &#39;create/&#39; + obj, this.someUrl);\n}</code></pre>\n<p>However, on Java side we get that attribute in double quotes as <code>{ &quot;flag&quot;:&quot;true&quot; }</code>, although there it is also defined as Boolean.</p>\n<p>Is there anything we can do to avoid those double quotes, to receive it as normal Boolean?</p>\n	2020-10-19 16:41:23.796578+03	20	5	{2}	\N	\N
...
8	sloh@mail.com	123456	SLOH Pink Cool	https://i.pinimg.com/236x/37/16/e9/3716e955bee79845b4a72e8b152023e0.jpg	2020-08-28 11:30:56.948947+03	\N
...
7	jessie1@mail.com	123456	Jessica Parker	https://i.pinimg.com/236x/42/2c/18/422c18b61ed2af843c0fc8776352e4d5.jpg	2020-08-21 04:06:31.379266+03	\N
16	jessie@mail.com	123456	Gonca Feray	https://i.pinimg.com/236x/51/04/7e/51047e025e7e6bf48ca300b96d81c28c.jpg	2020-09-19 07:42:08.155349+03	\N
...
15	famosa@mail.com	123456	Funda İrem	https://i.pinimg.com/236x/7c/7f/f0/7c7ff0e13c5e77d6eb4f4bd9cb769b7f.jpg	2020-09-19 07:41:45.868564+03	\N
...
5	sahnaz@mail.com	123456	Şahnaz Selma	https://i.pinimg.com/236x/a7/b8/1d/a7b81d6d34bc9e47bb7e7f3caefdc751.jpg	2020-08-16 04:22:44.970259+03	\N
...
14	arabella@mail.com	123456	Arabella	https://yt3.ggpht.com/a/AATXAJzysVDEYaGK2pe0UR45_eErAmAwGV97sU_898R-=s48-c-k-c0xffffffff-no-nd-rj-mo	2020-09-19 07:37:06.417994+03	\N
3	aaa@mail.com	bbb	Olcay Usta	https://i.pinimg.com/236x/18/0f/af/180fafb09f247c4a8593f759ed7de18a.jpg	2020-08-15 19:26:45.713453+03	\N
...
20	irmak@mail.com	123456	Irmak Sevinç	https://i.pinimg.com/236x/b3/57/dc/b357dcd764b6ba129e935bf28d929a1b.jpg	2020-10-19 16:44:01.791771+03	\N
21	aysu@mail.com	123456	Aysu Güçin	https://i.pinimg.com/236x/2b/28/24/2b2824f9369b1ba782eab8882af93740.jpg	2020-10-19 18:45:55.245831+03	\N
\.
...
SELECT pg_catalog.setval('public.answer_id_seq', 45, true);
...
SELECT pg_catalog.setval('public.user_favorite_tags_id_seq', 3, true);
